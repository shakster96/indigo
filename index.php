...
<div class="row">
	...
	<?php
		echo"<script>function test(){ alert(\"This works\");}</script>";
	...
	if ($result->num_rows > 0) {
		...
		echo "<br><button onclick=\"test(123)\" type=\"button\" class=\"btn btn-primary btn-lg active\" id=\"attended\" ><span class=\"glyphicon glyphicon-ok\"></span></button>";	// image
		echo "</div></div></div><br>";
		echo "";
		echo "";
		}
